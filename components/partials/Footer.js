...
export function Footer() {
    return <footer className="relative ">
        <div className=" absolute bottom-0 md:bottom-10 left-0 w-full h-full  ">
            <img src="/assets/footer.png" className=" w-full h-[517px]" />
        </div>
        <div className=" r-container relative z-10 pt-20 md:pt-40 pb-10 ">
